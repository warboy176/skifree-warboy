...
- [ ] Update the depthMeter in the game loop by incrementing it with deltaY multiplied by METERS_PER_PIXEL
- [ ] Ensure the depthMeter is initialized to 0 at game start and persists through restarts
